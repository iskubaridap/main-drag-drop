...
var useTopNav = false;
var resourcesPath = SCORM ? "./resources/" : "https://projectcog.com/user_files/McAfee/resources/";
var pptPath = SCORM ? "./ppt/" : "http://projectcog.com/user_files/McAfee/resources/ppt/indicate_your_course_here/";
var pdfPath = SCORM ? "./pdf/" : "https://projectcog.com/user_files/McAfee/resources/pdf/indicate_your_course_here/";
var audioPath = SCORM ? "../media/audio/" : "https://projectcog.com/user_files/McAfee/resources/audio/indicate_your_course_here/";
var videoPath = SCORM ? "./media/video/" : "https://projectcog.com/user_files/McAfee/resources/video/indicate_your_course_here/";
...
var shuffleAnswer= function()
{
    ...
    if(!$("#choice").hasClass("mapQuiz"))
    {
        ...
        {
            $(arryMultiChoice[i]).find("label").html((letters.charAt(i) + ") " + $(arryMultiChoice[i]).find("label").html().replace(/\w\) /,"")));
