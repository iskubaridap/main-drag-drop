...
var SCORM2004_ENTRY_ABINITIO = "ab_initio";
...
function SCORM2004_Initialize(){
	...
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.exit", SCORM2004_TranslateExitTypeToSCORM(DEFAULT_EXIT_TYPE));
...
function SCORM2004_Finish(strExitType, blnStatusWasSet){
	...
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.exit", SCORM2004_TranslateExitTypeToSCORM(strExitType));
	
	WriteToDebug("Calling Commit");
	
	blnResult = blnResult && SCORM2004_CallCommit();
	
	WriteToDebug("Calling Finish");
	
	blnResult = blnResult && SCORM2004_CallTerminate();	
...
function SCORM2004_SetDataChunk(strData){
	WriteToDebug("In SCORM2004_SetDataDChunk");
	SCORM2004_ClearErrorInfo();
...
function SCORM2004_WriteComment(strComment){
	...
	blnResult = blnResult & SCORM2004_CallSetValue("cmi.comments_from_learner." + intCurrentIndex + ".timestamp", ConvertDateToIso8601TimeStamp(new Date()));
...
function SCORM2004_SetScore(intScore, intMaxScore, intMinScore){
	...
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.score.max", intMaxScore);
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.score.min", intMinScore);
	
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.score.scaled", fltNormalizedScore);
...
function SCORM2004_RecordInteraction(strID, strResponse, blnCorrect, strCorrectResponse, strDescription, intWeighting, intLatency, strLearningObjectiveID, dtmTime, SCORM2004InteractionType){
	...
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.interactions." + intInteractionIndex + ".type", SCORM2004InteractionType);
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.interactions." + intInteractionIndex + ".learner_response", strResponse);
	
	if (strResult != undefined && strResult != null && strResult != ""){
		blnResult = blnResult && SCORM2004_CallSetValue("cmi.interactions." + intInteractionIndex + ".result", strResult);
	}
	
	if (strCorrectResponse != undefined && strCorrectResponse != null && strCorrectResponse != ""){
		blnResult = blnResult && SCORM2004_CallSetValue("cmi.interactions." + intInteractionIndex + ".correct_responses.0.pattern", strCorrectResponse);	
	}
	
	if (strDescription != undefined && strDescription != null && strDescription != ""){
		blnResult = blnResult && SCORM2004_CallSetValue("cmi.interactions." + intInteractionIndex + ".description", strDescription);
	}
	
	if (intWeighting != undefined && intWeighting != null && intWeighting != ""){
		blnResult = blnResult && SCORM2004_CallSetValue("cmi.interactions." + intInteractionIndex + ".weighting", intWeighting);
	}

	if (intLatency != undefined && intLatency != null && intLatency != ""){
		blnResult = blnResult && SCORM2004_CallSetValue("cmi.interactions." + intInteractionIndex + ".latency", ConvertMilliSecondsIntoSCORM2004Time(intLatency));
	}
	
	if (strLearningObjectiveID != undefined && strLearningObjectiveID != null && strLearningObjectiveID != ""){
		blnResult = blnResult && SCORM2004_CallSetValue("cmi.interactions." + intInteractionIndex + ".objectives.0.id", strLearningObjectiveID);
	}
	
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.interactions." + intInteractionIndex + ".timestamp", ConvertDateToIso8601TimeStamp(dtmTime));
...
function SCORM2004_SetObjectiveScore(strObjectiveID, intScore, intMaxScore, intMinScore){
	...
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.objectives." + intObjectiveIndex + ".score.raw", intScore);
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.objectives." + intObjectiveIndex + ".score.max", intMaxScore);
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.objectives." + intObjectiveIndex + ".score.min", intMinScore);
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.objectives." + intObjectiveIndex + ".score.scaled", fltNormalizedScore);
...
function SCORM2004_SetObjectiveStatus(strObjectiveID, Lesson_Status){
	...
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.objectives." + intObjectiveIndex + ".success_status", strSCORMSuccessStatus);
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.objectives." + intObjectiveIndex + ".completion_status", strSCORMCompletionStatus);
...
function SCORM2004_SetObjectiveDescription(strObjectiveID, strObjectiveDescription){
	...
	blnResult = SCORM2004_CallSetValue("cmi.objectives." + intObjectiveIndex + ".id", strObjectiveID);
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.objectives." + intObjectiveIndex + ".description", strObjectiveDescription);
...
function SCORM2004_GetObjectiveStatus(strObjectiveID){
	...
	else if (strCompletionStatus == SCORM2004_NOT_ATTEMPTED || strCompletionStatus == SCORM2004_UNKNOWN || strStatus == ""){
...
function SCORM2004_SetFailed(){
	...
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.completion_status", SCORM2004_COMPLETED);
...
function SCORM2004_ResetStatus(){
	...
	blnResult = blnResult && SCORM2004_CallSetValue("cmi.completion_status", SCORM2004_INCOMPLETE);
